...
%% Increase distal limb stiffness by 25%
function X = cheetah_rotary_12ms(X0,k,zeta,counter)
import casadi.*

ex_front = 0.35989; ex_hind = 0.34085; 
I_cheetah = 0.4750; b = zeta*2*sqrt(I_cheetah*k);
k_legs = 1.25*5000; b_legs = 90; 
...
save(append(num2str(k),'_k_cheetah_extended_12ms.mat'),"Data")
