...
% clc;
% tic;
function X = horse_rotary_12ms(X0, k, zeta, counter)
import casadi.*

% ex_front = 0.712; ex_hind = 0.485; 
ex_front = 1.097; ex_hind = 0.87; % height 1.61
I_horse = 33.4713; b = zeta*2*sqrt(I_horse*k);

k_legs = 1.25*55000; b_legs = 750; 
...
%%
% horse_seed = load("horse_seed_extended.mat");
% X0 = horse_seed.X; 
...
% 
% X_new = solvedproblem.Seed.Data; 
% N = solvedproblem.Seed.NewN; 
%% Save data
Data = solvedproblem.Data;
save(append(num2str(k),'_k_horse_extended_12ms.mat'),"Data")
