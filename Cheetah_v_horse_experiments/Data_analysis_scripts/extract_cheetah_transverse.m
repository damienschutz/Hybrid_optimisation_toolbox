% =========================================================
% extract_cheetah_transverse.m
% OUTPUT: cheetah_rotary_results.csv
% =========================================================
...
MASS        = 45.5;
GAIT        = 'transverse';
FOLDER_NAME = 'Cheetah_Transverse';
SPEEDS_MS   = [8, 10, 12, 15];
OUT_CSV     = 'cheetah_transverse_results.csv';
...
LIMB_PHASES.LF = [5, 6, 7];   % Left  Fore
LIMB_PHASES.RF = [7, 8];   % Right Fore
LIMB_PHASES.LH = [2, 3];   % Left  Hind
LIMB_PHASES.RH = [3, 4, 5];   % Right Hind
FLIGHT_PHASE   = [1];
% ---------------------------------------------------------
