%% Grounded transverse gallop horse - 12ms
...
problem = SolveNLP(problem, X0);

%% Create new seed and extract data
problem = problem.ExtractData(); 
...
%% Save data
Data = problem.Data;
save(append(num2str(k),'_k_horse_grounded_12ms',num2str(counter),'.mat'),"Data")
X = full(problem.Solution.x);
