...
function X = cheetah_rotary_15ms(X0,k,zeta,counter)
import casadi.*
...
P8.ConstraintList = P8.ConstraintList.AddConstraint("Total Time", (t1+t2+t3+t4+t5+t6+t7+t8), 0.25, 0.37); 
...
save(append(num2str(k),'_k_cheetah_extended_15ms.mat'),"Data")
