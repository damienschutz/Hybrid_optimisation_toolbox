...
function X = horse_transverse_8ms(X0, k, zeta, counter)
% clear;
% clc;
...
P8.ConstraintList = P8.ConstraintList.AddConstraint("Total Time", (t1+t2+t3+t4+t5+t6+t7+t8), 0.25, 1); 
...
save(append(num2str(k),'_k_horse_grounded_8ms.mat'),"Data")
