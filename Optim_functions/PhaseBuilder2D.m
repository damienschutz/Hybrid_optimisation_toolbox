function obj = PhaseBuilder2D(obj)
    ...
    if NB > 2
        TAU = Variable('TAU', [NB-2,1]); TAU.Type = "Torque_Input"; 
    else
    ...
    switch scheme
        case 'Trapezoidal'
            ...
            if isempty(obj.ContactConfiguration)
                ...
                for i = 1:NF
                    GRF = Variable(['GRF_' num2str(obj.ContactConfiguration{i})], [2 1], [-1000;0], [1000;1000]);
            ...
            if isempty(obj.ContactConfiguration)
                ...
                for i = 1:N-1 
                    ...
                    % Foot clearance
                    obj = FootConstraints2D(obj, x_next);
                ...
                NH = 2*NF; % number of holonmic constraints
        ...
        case 'Hermite-Simpson'
            ...
            if isempty(obj.ContactConfiguration)
                ...
                for i = 1:N-1 
                   ...
                   % Foot clearance 
                   obj = FootConstraints2D(obj, x2);
                   obj = FootConstraints2D(obj, x3);
    ...
    if obj.Transition.Type == "Impact"
        ...
        obj = FootConstraintsImpact2D(obj,x_final); 
    elseif obj.Transition.Type == "Lift Off"
        ...
        for j = 1:numel(obj.Transition.Contacts)
            ...
            obj.ConstraintList = obj.ConstraintList.AddConstraint("Lift Off " + obj.Transition.Contacts{j},gr_liftoff(2), 0, 0); 
        end
